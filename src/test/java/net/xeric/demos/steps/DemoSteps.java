...
public class DemoSteps {
    ...
    @When("^I convert number (-?\\d+)$")
    public void i_convert_number(int arg1) throws Throwable {
        demoPage.convertToRoman(arg1);
    }

    @Then("^the conversion result is (.*)$")
    public void the_conversion_result_is(String arg1) throws Throwable {
        assertEquals(arg1, demoPage.getRomanNumeral());
    }
