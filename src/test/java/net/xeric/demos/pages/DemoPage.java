...
public class DemoPage {
    ...
    public void convertToRoman(int x){
        driver.findElement(By.id("romanNumberConverter-number")).sendKeys(Integer.toString(x));
        driver.findElement(By.id("romanNumberConverter-button")).click();
    }

    public String getRomanNumeral(){
        return driver.findElement(By.id("romanNumberConverter-result")).getText();
    }
